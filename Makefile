...
# Source Files
SRC = parsing/node_init.c parsing/tokenize.c parsing/tokenize_utils.c parsing/for_test.c parsing/tokenize2.c parsing/parse2.c parsing/parsing.c parsing/commands.c main.c 
OBJ = $(SRC:.c=.o)
